...
cd ~
sudo apt-get --yes install python-pip python-slowaes python-socksipy pyqt4-dev-tools
sudo apt-get --yes install python-pip python-qt4 pyqt4-dev-tools python-slowaes python-ecdsa python-zbar
sudo apt-get --yes install python-pip python-qt4 pyqt4-dev-tools python-zbar
